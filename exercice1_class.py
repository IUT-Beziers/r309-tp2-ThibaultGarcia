from tkinter import (Tk, Canvas, N, W, E, S, Event, Button, Frame, PhotoImage)
...
class App(Tk):
    def __init__(self,name,width,height):
        ...
        self.button_router = Button(self.frame,image=self.img_router, command=lambda: self.spawn(self.img_router))
    ...
    #apparition de l'élément cliqué
